...
using Java.IO;
using ARPlaneDetection.Rendering;
using ARPlaneDetection.Helpers;

namespace ARPlaneDetection
{
    [Activity(Label = "Plane Detection", MainLauncher = true, Icon = "@mipmap/icon", Theme = "@style/Theme.AppCompat.NoActionBar", ConfigurationChanges = Android.Content.PM.ConfigChanges.Orientation| Android.Content.PM.ConfigChanges.ScreenSize, ScreenOrientation = Android.Content.PM.ScreenOrientation.Locked)]
    public class MainActivity : AppCompatActivity, GLSurfaceView.IRenderer, Android.Views.View.IOnTouchListener
    {
        ...
        public void OnSurfaceCreated(IGL10 gl, Javax.Microedition.Khronos.Egl.EGLConfig config)
        {
            ...
            try
            {
                ...
                mVirtualObjectShadow.CreateOnGlThread(/*context=*/this, "andy_shadow.obj", "andy_shadow.png");
            ...
            try
            {
                ...
                foreach (AugmentedImage img in updatedAugmentedImages)
                {
                    ...
                    if (img.TrackingState == TrackingState.Tracking)
                    {
                        ...
                        if (img.Index == index)
                        {
                            var anchor = img.CreateAnchor(img.CenterPose);
                            mAnchors.Add(anchor);
                            mVirtualObject.CreateOnGlThread(/*context=*/this, "andy.obj", "andy.png");
                            mVirtualObject.setMaterialProperties(0.0f, 3.5f, 1.0f, 6.0f);
        ...
        private void ShowLoadingMessage()
        {
            this.RunOnUiThread(() =>
            {
                mLoadingMessageSnackbar = Snackbar.Make(FindViewById(Android.Resource.Id.Content), "Searching for surfaces...", Snackbar.LengthIndefinite);
